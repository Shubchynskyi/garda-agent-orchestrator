...
8. The `validation_lane` runs the configured full-suite command as advisory continuity evidence. It creates no linked child, implementation commit, review receipt, completion evidence, or release claim.
