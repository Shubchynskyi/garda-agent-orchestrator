...
2. Move the parent task into a blocked/split state through supported task controls when available, or by explicit backlog editing when no gate exists for that transition.
