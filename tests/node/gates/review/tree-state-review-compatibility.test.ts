...
test('tree-state review compatibility suite keeps the focused regression shards wired together', () => {
    for (const [relativePath, expected] of [
        ...
        [
            'tests/node/cli/commands/gates/review-launch/gates-command-review-launch-routing.test.ts',
            "record-review-routing rejects schema-less review contexts without tree_state binding"
        ],
        [
            'tests/node/cli/commands/gates/review-launch/gates-command-review-launch-prepared.test.ts',
        ...
        [
            'tests/node/cli/commands/gates/review-result/gates-command-review-result-receipt.test.ts',
        ...
        [
            'tests/node/cli/commands/gates/review-reuse/gates-review-reuse-stale-evidence.test.ts',
