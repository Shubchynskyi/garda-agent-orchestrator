...
test('tree-state review compatibility suite keeps the focused regression shards wired together', () => {
    for (const [relativePath, expected] of [
        [
            'tests/node/gates/review/review-tree-state.test.ts',
        ...
        [
            'tests/node/gates/review/reviewer-launch-tree-state.test.ts',
        ...
        [
            'tests/node/gates/review-context/review-context-contract.test.ts',
        ...
        [
            'tests/node/gates/review-reuse/review-reuse.test.ts',
        ...
        [
            'tests/node/cli/commands/gates/required-reviews/gates-command-required-reviews-safety-suite.ts',
            "fails required reviews gate when receipt tree-state binding is missing or tampered"
        ],
        [
            'tests/node/cli/commands/gates/review-launch/gates-command-review-launch-routing-suite.ts',
            "record-review-routing rejects schema-less review contexts without tree_state binding"
        ],
        [
            'tests/node/cli/commands/gates/review-launch/gates-command-review-launch-prepared-suite.ts',
        ...
        [
            'tests/node/cli/commands/gates/review-result/gates-command-review-receipt-routing.test.ts',
        ...
        [
            'tests/node/cli/commands/gates/review-reuse/gates-review-reuse-remediation.test.ts',
...
test('tree-state review compatibility suite documents Windows symlink privilege skips', () => {
    const reviewTreeStateSource = readRepoFile('tests/node/gates/review/review-tree-state.test.ts');
