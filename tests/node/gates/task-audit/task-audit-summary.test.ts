        ...
        it('surfaces reviewer timing provenance only in operator audit output', () => {
            ...
            const events = writeIntegrityEventSequence(eventsDir, taskId, [
                ...
                { event_type: 'REVIEW_PHASE_STARTED' },
                {
                    ...
                    details: {
                        ...
                        provider_invocation_attestation_id: 'attestation:task-audit-summary',
                        provider_invocation_attestation_source: 'codex_subagent',
                        ...
                        provider_invocation_attested_at_utc: timing.invocation_attested_at_utc,
                        ...timing
                    }
                },
                { event_type: 'REVIEW_GATE_PASSED' },
            ...
            receipt.reviewer_provenance = {
                ...
                provider_invocation: {
                    ...
                    attestation_id: 'attestation:task-audit-summary',
                    attestation_source: 'codex_subagent',
                    invocation_kind: 'provider',
                    invocation_id: 'codex-subagent-run-123',
                    reviewer_launch_attempt_id: '11111111-1111-4111-8111-111111111111',
                    launch_binding_sha256: 'e'.repeat(64),
                    launch_input_mode: 'launch_artifact_path',
                    launch_input_sha256: 'f'.repeat(64),
                    authenticated_at_utc: timing.invocation_attested_at_utc
                },
                launch_prepared_at_utc: timing.launch_prepared_at_utc,
                delegation_started_at_utc: timing.delegation_started_at_utc,
            ...
            assert.equal(entry.delegation_to_result_ms, 53000);
            assert.equal(entry.delegation_to_source_mtime_ms, 54000);
            assert.equal(entry.gate_finalize_ms, 18000);
