...
export function makeTempRepo(): string {
    ...
    fs.writeFileSync(
        ...
        [
            ...
            '',
            '## Instructions',
            'The parent implementation is suspended in the manifest and the captured paths were removed from the worktree.',
...
export function writeReviewCycleContinuation(
    repoRoot: string,
    taskId: string,
    options: {
