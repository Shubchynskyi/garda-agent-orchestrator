...
const ENGLISH_LOCAL_UI_TEXT = Object.freeze({
    ...
    cleanupPreviewHelp: 'Preview settings, cleanup, or task purge commands here before applying any destructive action.',
    ...
    cleanupEditSettingsHelp: 'Persist daily cleanup controls to runtime-retention.json. Preview validates the new values; Save requires typed confirmation.',
    cleanupMaxTasksPerRun: 'Max tasks per run',
    cleanupRunTitle: 'Dry-run and apply',
    cleanupRunHelp: 'Run runtime cleanup with explicit age and count bounds. Preview is dry-run; Apply requires confirmation.',
