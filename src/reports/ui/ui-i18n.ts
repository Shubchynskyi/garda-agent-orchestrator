...
const ENGLISH_LOCAL_UI_TEXT = Object.freeze({
    ...
    profileFindingDispositionHelp: 'Choose what happens to review findings. Critical is locked to fix_now. Changes affect future tasks only; active task snapshots stay unchanged.',
