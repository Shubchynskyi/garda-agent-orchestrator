...
export const COMMAND_HELP: Readonly<Record<CommandHelpName, CommandHelpDescriptor>> = Object.freeze({
    ...
    workflow: Object.freeze({
        ...
        hints: Object.freeze([
            ...
            'Optional quality checks are advisory, default-enabled, routed before expensive gates when current implementation changes need checklist evidence, and configurable with --optional-checks on|off plus --optional-check-rule-* without replacing mandatory compile/review/full-suite gates. Use --optional-check-rule-exclude-test-only true to skip one rule only for pure test changes.',
