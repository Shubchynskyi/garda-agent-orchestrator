...
export const COMMAND_HELP: Readonly<Record<CommandHelpName, CommandHelpDescriptor>> = Object.freeze({
    ...
    workflow: Object.freeze({
        ...
        hints: Object.freeze([
            ...
            'Short aliases map exactly to existing boolean settings: --full-suite, --scope-budget, --review-cycle, --review-cycle-auto-split, --project-memory, --task-reset, and --auto-backup accept on|off.',
