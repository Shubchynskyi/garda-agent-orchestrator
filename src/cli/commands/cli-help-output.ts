...
export const COMMAND_HELP: Readonly<Record<CommandHelpName, CommandHelpDescriptor>> = Object.freeze({
    ...
    workflow: Object.freeze({
        ...
        hints: Object.freeze([
            ...
            'Optional quality checks are advisory, default-enabled, and configurable with --optional-checks on|off without replacing mandatory compile/review/full-suite gates.',
