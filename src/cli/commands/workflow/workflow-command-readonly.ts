...
export function handleExplain(options: ParsedOptionsRecord): WorkflowExplainResult {
    ...
    const result: WorkflowExplainResult = {
        ...
        explanation: [
            ...
            'Scope budget guard compares changed file count, changed line count, distinct required review type count, and estimated review tokens against workflow-config.json limits.',
