...
const REVIEWER_LAUNCH_INPUT_ARTIFACT_FILE_NAME = 'reviewer-launch-input.json';
...
function resolveReviewerLaunchInputArtifactPath(reviewerLaunchArtifactPath: string): string {
...
function snapshotSupersededReviewerLaunchArtifact(options: {
    artifactPath: string;
    mismatches: string[];
...
function getCurrentPreparedReviewerLaunchMismatches(options: {
    artifactPath: string;
    artifact: Record<string, unknown>;
    taskId: string;
    reviewType: string;
...
function isCurrentCompletedReviewerLaunchArtifact(options: {
    repoRoot: string;
    artifactPath: string;
    taskId: string;
    reviewType: string;
