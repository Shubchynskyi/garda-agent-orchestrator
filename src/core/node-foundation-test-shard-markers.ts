export const NODE_FOUNDATION_TEST_MARKERS = {
    ...
    DURATION_TELEMETRY_UPDATE_SKIPPED: 'NODE_FOUNDATION_TEST_DURATION_TELEMETRY_UPDATE_SKIPPED',
    SHARD_PLAN: 'NODE_FOUNDATION_TEST_SHARD_PLAN',
    SHARD_COMPARISON: 'NODE_FOUNDATION_TEST_SHARD_COMPARISON',
    ...
    SHARD_FAILURE_SUMMARY: 'NODE_FOUNDATION_TEST_SHARD_FAILURE_SUMMARY',
    SHARD_FAILURE_TEST: 'NODE_FOUNDATION_TEST_SHARD_FAILURE_TEST',
    SHARD_FAILURE_TAIL: 'NODE_FOUNDATION_TEST_SHARD_FAILURE_TAIL'
} as const;
