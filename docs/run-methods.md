...
Before pushing `v1.4.2`, complete these repository and registry checks:
...
npm view garda-agent-orchestrator@1.4.2 version dist.integrity
npx --yes garda-agent-orchestrator@1.4.2 --version
```
